...
// GetInfoWriterOriginal returns the original info writer.
...
// RemoveFileWriter removes a potentially added file writer.
...
// MoveFileWriterToEnd moves the the write pointer to the end of the file.
