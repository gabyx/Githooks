...
1. Shared hook repos may only contain hooks in their root dir of the repository
...
4. Replaced hooks can no more be ignored by worktree ignores
...
Or should we put that configuration stuff inside
