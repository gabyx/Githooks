...
```
      ...
      --hooksDir string              The preferred directory to use for maintaining Githook's hook run-wrappers.
      ...
      --centralized           If the install mode `core.hooksPath` should be used.
