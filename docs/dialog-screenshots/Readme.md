# Dialog Tool Screenshots

## Linux

![Message with error icon.](linux/message-1.png)

![Message with warning icon.](linux/message-2.png)
...
![Options dialog.](linux/options-1.png)

![Options dialog with buttons.](linux/options-2.png)

![File selection dialog.](linux/file-selection.png)

![Directory selection dialog.](linux/directory-selection.png)
