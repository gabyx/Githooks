...
"$GH_INSTALL_BIN_DIR/githooks-cli" shared add --shared file://"$GH_TEST_TMP/test115.shared/shared-repo.git" &&
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared list | grep "shared-repo" | grep "pending" &&
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared pull || exit 4
