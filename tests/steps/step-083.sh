...
function test_shared() {
    ...
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared add --shared "$url1" || exit 1
    ...
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared add --shared file://"$GH_TEST_TMP/shared/second-shared.git" || exit 5
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared add file://"$GH_TEST_TMP/shared/third-shared.git" || exit 6
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared list --shared | grep "second-shared" | grep "pending" || exit 7
    ...
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared remove --shared file://"$GH_TEST_TMP/shared/first-shared.git" || exit 11
    ! "$GH_INSTALL_BIN_DIR/githooks-cli" shared list | grep "first-shared" || exit 12
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared remove --shared file://"$GH_TEST_TMP/shared/second-shared.git" || exit 13
    "$GH_INSTALL_BIN_DIR/githooks-cli" shared remove file://"$GH_TEST_TMP/shared/third-shared.git" || exit 14
